...
async def call_ollama(prompt: str, model: str = "llama3.2", context: Optional[List[int]] = None, temperature: Optional[float] = None) -> Dict[str, Any]:
    """Call Ollama API similar to the PHP function"""
